...
//        window.location = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfac68d0e2faf11ab&redirect_uri=http%3A%2F%2Fwww.51upali.com&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect'
//      } else {
